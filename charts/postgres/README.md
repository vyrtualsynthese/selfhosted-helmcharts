...
This chart set up a simple postgresql Database in your kubernetes Kluster.  
This chart is ment to be inherited by other charts from Selfhoster-helmchart repo.
